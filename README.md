...
![Status](https://github.com/linden/man/workflows/Go/badge.svg)
...
[the eavesdropper example](https://github.com/linden/man/blob/master/examples/goproxy-eavesdropper/main.go#L27)
2. Transparent proxy support for http/https including MITM certificate generation for TLS.  See the [transparent example.](https://github.com/linden/man/tree/master/examples/goproxy-transparent)
